...
my_label_env_sex <- LabelEncoder$new()
my_summary$sexe <- my_label_env_sex$fit_transform(my_summary$sexe)
my_label_env_sport <- LabelEncoder$new()
my_summary$sport <- my_label_env_sport$fit_transform(my_summary$sport)
