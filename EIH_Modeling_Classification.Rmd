...
if (params$data != "none") {
  imported_data_names <-
    basename(params$data) %>% tools::file_path_sans_ext()
  imported_data <-
    params$data %>%
  ...
  imported_data_names <-
    basename(params$data_list) %>% tools::file_path_sans_ext()
  imported_data <-
  ...
  imported_data_names <-
    basename(params$data_folder) %>% tools::file_path_sans_ext()
  imported_data <-
...
describe(x = analysis_data[c("train_years",
  ...
  my_table(
    caption = paste0(
      "<center><strong>Données d'entraînement des athlètes (n = ",
      nrow(analysis_data) ,
      ")</center></strong>"
    )
  )
